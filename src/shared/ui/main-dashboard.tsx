                  ...
                  <div key={todo.id} className="p-3 rounded-xl hover:bg-gray-800 transition-colors">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {todo.dueTime && (
                          <p className="text-xs text-gray-400">{formatTime(todo.dueTime)}</p>
                        )}
                      </div>
                    </div>
                  </div>
        ...
        <Card className="border-gray-800 bg-gray-900">
          ...
          <CardContent className="space-y-3">
            {memos.slice(0, 2).map(memo => (
              <div
                key={memo.id}
                className="p-4 rounded-xl border border-gray-800 hover:bg-gray-800 transition-colors"
              >
      ...
      <main className="px-4 pt-20 pb-8 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          {[1, 2].map(index => (
            <div
              key={index}
              className="h-16 bg-gray-800 rounded-xl border border-gray-700 animate-pulse"
            ></div>
          ))}
        </div>
      </main>
